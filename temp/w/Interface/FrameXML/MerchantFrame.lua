...
function MerchantFrame_UpdateMerchantInfo()
	...
	MerchantPageText:SetText(format(PAGE_NUMBER, MerchantFrame.page));
...
function MerchantItemButton_OnModifiedClick(button)
	...
	elseif ( button == "LeftButton" ) then
		if ( IsShiftKeyDown() ) then
			ChatEdit_InsertLink(GetBuybackItemLink(this:GetID()));
		elseif ( IsControlKeyDown() ) then
			DressUpItemLink(GetBuybackItemLink(this:GetID()));
		end
	end
end
