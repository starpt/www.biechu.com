...
function MovieFrame_PlayMovie(index)
	...
	if ( not MovieList[this.version] or not MovieList[this.version][index] or not MovieList[this.version][index][this.resolution] ) then
		this:Hide();
		return;
	elseif ( not MovieList[this.version][index][this.resolution].video or not this:StartMovie(MovieList[this.version][index][this.resolution].video, MovieVolumeList[this.version]) ) then
