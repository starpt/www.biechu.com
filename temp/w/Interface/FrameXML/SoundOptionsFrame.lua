...
SoundOptionsFrameCheckButtons["ENABLE_HARDWARE"] = { index = 10, cvar = "SoundUseHardware", initialValue = nil , tooltipText = OPTION_TOOLTIP_ENABLE_HARDWARE, restartClient = 1, tooltipRequirement = OPTION_RESTART_REQUIREMENT};
...
SoundOptionsFrameSliders = {
	...
	{ index = 5, text = SOUND_CHANNELS, cvar = "SoundNumChannels", minValue = 1, maxValue = 4, valueStep = 1, initialValue = nil, tooltipText = OPTION_TOOLTIP_SOUND_CHANNELS, restartClient = 1, tooltipRequirement = OPTION_RESTART_REQUIREMENT},
};
...
function SoundOptionsFrame_Load()
	...
	for index, value in pairs(SoundOptionsFrameSliders) do
		...
		-- Save the intial value
		if ( value.cvar == "SoundNumChannels" ) then
