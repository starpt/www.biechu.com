...
AURADISPELOTHER3 = "%s的%s被%s的%s移除了。";
AURADISPELOTHER2 = "%s的%s被%s移除了。";
AURADISPELSELF = "你的%s被移除了。";
AURADISPELSELF3 = "你的%s被%s的%s移除了。";
AURADISPELSELF2 = "你的%s被%s移除了。";
...
AUTO_DISMOUNT_FLYING_TEXT = "自动下马";
...
BAG_ITEM_NO_SPLIT_WHILE_PROSPECTING = "选矿时不能那么做";
...
BENCHMARK_TAXI_MODE_OFF = "Taxi benchmark模式关闭。";
BENCHMARK_TAXI_MODE_ON = "Taxi benchmark模式开启。";
BENCHMARK_TAXI_RESULTS = "Taxi benchmark得分：";
...
CHAT_BATTLEGROUND_GET = "[战场] %s:\32";
CHAT_BATTLEGROUND_LEADER_GET = "[战场领袖] %s:\32";
...
CHAT_MONSTER_PARTY_GET = "[小队] %s:\32"; -- Party message from NPC\Monster %s
...
CLICK_TO_ENTER_COMMENT = "点击这里输入评论";
...
COLOR = "颜色";
COLOR_PICKER = "颜色选择器";
COMBATHITCRITOTHEROTHER = "%s的爆击对%s造成%d点伤害。";
...
COMBATHITCRITSELFOTHER = "你的爆击对%s造成%d点伤害。";
...
COMBATLOG_HONORGAIN = "%s死亡，荣誉击杀军衔：%s（荣誉点数预估：%d）";
...
ENCHANT_CONDITION_EQUAL_VALUE_P1 = "%d颗%s宝石";
ENCHANT_CONDITION_LESS_VALUE = "少于%d颗%s宝石";
ENCHANT_CONDITION_LESS_VALUE_P1 = "少于%d颗%s宝石";
...
ERROR_SLASH_TEAM_DEMOTE = "正确的格式为/teamdemote [2v2, 3v3, 5v5] [玩家名字]";
...
ERR_GUILD_NAME_INVALID_SPACE = "名称无法以空格开始或结束。请输入一个新名称。";
...
ERR_NO_SPLIT_WHILE_PROSPECTING = "选矿时不能那么做";
...
ERR_UNKNOWN_MACRO_OPTION = "未知的宏设置：%s";
...
HONOR_ESTIMATED_TOOLTIP = "本日预计荣誉";
HONOR_GAINED = "获得荣誉";
...
HP_TEMPLATE = "%d生命值";
HUNTER_AGILITY_TOOLTIP = "提高你的近战武器和远程武器的攻击强度，并提高所有武器的爆击几率。\n提高你的护甲值和躲避攻击的几率。";
...
INT_GENERAL_DURATION_DAYS_P1 = "%d天";
INT_GENERAL_DURATION_HOURS = "%d小时";
INT_GENERAL_DURATION_HOURS_P1 = "%d小时";
INT_GENERAL_DURATION_MIN = "%d分钟";
INT_GENERAL_DURATION_MIN_P1 = "%d分钟";
INT_GENERAL_DURATION_SEC = "%d秒";
INT_GENERAL_DURATION_SEC_P1 = "%d秒";
...
KBASE_ERROR_LOAD_FAILURE = "知识库目前不可用。请使用下面的按钮寻求在线帮助。";
...
LOOT_ROLL_WON_NO_SPAM_GREED = "%1$s赢得了：%3$s |cff818181(Greed - %2$d)|r";
LOOT_ROLL_WON_NO_SPAM_NEED = "%1$s赢得了：%3$s |cff818181(Need - %2$d)|r";
...
NEWBIE_TOOLTIP_LFGTAB = "点击这里寻找一支符合你的搜索条件的队伍。";
...
NEWBIE_TOOLTIP_MANABAR3 = "盗贼（以及德鲁伊的猎豹形态）需要能量来使用他们的技能。能量会不断地自动恢复。";
...
ONE_DAILY_QUEST_REMAINING = "你今天只能再完成一个日常任务了。"; -- Same as DAILY_QUESTS_REMAINING, used when only one remains
...
OPTION_TOOLTIP_AUTO_DISMOUNT_FLYING = "钩选此项之后，当你施放任何法术时都会自动解除骑乘状态（甚至包括飞行坐骑！）。";
...
OPTION_TOOLTIP_AUTO_LOOT_DEFAULT = "将自动拾取设置为点击一个可拾取物品的怪物时的默认动作。（通过按住拾取键/自动拾取键，可以在钩选此项时手动拾取，或在未钩选此项时自动拾取。）";
OPTION_TOOLTIP_AUTO_LOOT_KEY_TEXT = "用来自动拾取物品的按键";
...
OPTION_TOOLTIP_AUTO_SELF_CAST = "开启此选项后，如果你周围没有友方目标或没有目标没，则可以对友方目标施放的法术会自动对你本人施放。";
...
OPTION_TOOLTIP_AUTO_SELF_CAST_KEY_TEXT = "按住这个键将会对自己施法，即使你当前锁定的目标是某个敌对怪物或玩家。";
...
OPTION_TOOLTIP_BUFFERING = "当垂直同步开启的时候启用三倍帧数缓冲。选择三倍缓冲可以提高你的帧数。";
...
OPTION_TOOLTIP_ENABLE_HARDWARE = "开启此选项以使用硬件声音加速。会降低运行速度。";
...
OPTION_TOOLTIP_SECURE_ABILITY_TOGGLE = "钩选此项之后，你将不会因为偶然的操作失误将快捷键从动作条上移除。";
...
OPTION_TOOLTIP_SHOW_TARGET_CASTBAR_IN_V_KEY = "在你选择了显示当前目标姓名板的情况下，在姓名板附近显示敌方施法条。"; -- CVar text for the current target castbar
...
OPTION_TOOLTIP_SOUND_CHANNELS = "改变软件声道的使用数量。";
...
PERCENT_SYMBOL = "%%";
PERIODICAURADAMAGEOTHER = "%4$s使%1$s受到了%2$d点%3$s伤害。";
...
PERIODICAURADAMAGESELF = "%3$s使你受到了%1$d点%2$s伤害。";
...
PERIODICAURAHEALOTHER = "%1$s由%3$s获得了%2$d点生命值。";
...
PERIODICAURAHEALSELF = "你由%2$s获得了%1$d点生命值。";
...
POWERGAINOTHER = "%1$s由%4$s获得了%2$d点%3$s。";
...
POWERGAINSELF = "你由%3$s获得了%1$d点%2$s。";
POWERGAINSELFOTHER = "%1$s由%4$s获得了%2$d点%3$s。"; -- Bob gains 5 mana from spell.
...
QUEST_LOG_DAILY_TOOLTIP = "你每天只能完成%d个日常任务。新的一天将在%s后开始。";
...
ROGUE_AGILITY_TOOLTIP = "提高你的近战武器和远程武器的攻击强度，并提高所有武器的爆击几率。\n提高你的护甲值和躲避攻击的几率。";
...
SHOW_TARGET = "显示目标";
SHOW_TARGET_CASTBAR = "显示敌方施法条 - 头像"; -- CVar text for the current target castbar
SHOW_TARGET_CASTBAR_IN_V_KEY = "显示敌方施法条 - 姓名板"; -- CVar text for the current target castbar
...
SPELL_PENETRATION_TOOLTIP = "降低目标对你的法术的抗性";
...
TEAM_PROMOTE = "提升为指挥官"; -- Team Management Unit PopUp
