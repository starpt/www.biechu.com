...
StaticPopupDialogs["REMOVE_GUILDMEMBER"] = {
	...
	OnShow = function()
		getglobal(this:GetName().."Text"):SetText(format(REMOVE_GUILDMEMBER_LABEL, GuildFrame.selectedName));
	end,
	timeout = 0,
	exclusive = 1,
	whileDead = 1,
...
StaticPopupDialogs["XP_LOSS"] = {
	...
	OnAccept = function(data)
		if ( data ) then
			getglobal(this:GetParent():GetName().."Text"):SetText(format(CONFIRM_XP_LOSS_AGAIN, data));
