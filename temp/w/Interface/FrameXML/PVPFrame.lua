...
function PVPTeam_Update()
	...
	-- Data Elements
	local teamName, teamSize, teamRating, teamPlayed, teamWins, teamLoss,  seasonTeamPlayed, seasonTeamWins, playerPlayed, playerPlayedPct, teamRank;
	...
	for index, value in pairs(ARENA_TEAMS) do
		if ( value.index ) then
			...
			-- Pull Values
			teamName, teamSize, teamRating, teamPlayed, teamWins,  seasonTeamPlayed, seasonTeamWins, playerPlayed, seasonPlayerPlayed, teamRank, background.r, background.g, background.b, emblem, emblemColor.r, emblemColor.g, emblemColor.b, border, borderColor.r, borderColor.g, borderColor.b = GetArenaTeam(value.index);
...
function PVPTeamDetails_Update(id)
	...
	local teamName, teamSize, teamRating, teamPlayed, teamWins,  seasonTeamPlayed, seasonTeamWins, playerPlayed, seasonPlayerPlayed, teamRank  = GetArenaTeam(id);		
	local button;
	local teamIndex;
	...
	for i=1, MAX_ARENA_TEAM_MEMBERS, 1 do
		...
		if ( i > numMembers ) then
			...
			getglobal("PVPTeamDetailsButton"..i.."NameText"):SetText(name);
			getglobal("PVPTeamDetailsButton"..i.."ClassText"):SetText(class);
			getglobal("PVPTeamDetailsButton"..i.."PlayedText"):SetText(playedValue);
			getglobal("PVPTeamDetailsButton"..i.."WinLossWin"):SetText(winValue);
			getglobal("PVPTeamDetailsButton"..i.."WinLossLoss"):SetText(lossValue);
			...
			getglobal("PVPTeamDetailsButton"..i.."NameText"):SetTextColor(r, g, b);
			getglobal("PVPTeamDetailsButton"..i.."ClassText"):SetTextColor(r, g, b);
			getglobal("PVPTeamDetailsButton"..i.."PlayedText"):SetTextColor(r, g, b);
			getglobal("PVPTeamDetailsButton"..i.."WinLossWin"):SetTextColor(r, g, b);
			getglobal("PVPTeamDetailsButton"..i.."WinLoss-"):SetTextColor(r, g, b);
			getglobal("PVPTeamDetailsButton"..i.."WinLossLoss"):SetTextColor(r, g, b);
